...
export function writeEthereum_TxRequest(writer: Write, type: Ethereum_TxRequest): void {
  ...
  writer.writeNullableString(type.from);
  writer.context().pop();
  ...
  writer.context().pop();
  writer.context().push("chainId", "Nullable<u32>", "writing property");
  writer.writeString("chainId");
  writer.writeNullableUInt32(type.chainId);
  writer.context().pop();
  writer.context().push("type", "Nullable<u32>", "writing property");
  writer.writeString("type");
  writer.writeNullableUInt32(type.type);
  writer.context().pop();
}
...
export function readEthereum_TxRequest(reader: Read): Ethereum_TxRequest {
  ...
  let _chainId: Nullable<u32> = new Nullable<u32>();
  ...
  while (numFields > 0) {
    ...
    if (field == "to") {
      ...
      reader.context().push(field, "Nullable<u32>", "type found, reading property");
      _chainId = reader.readNullableUInt32();
      reader.context().pop();
    }
    else if (field == "type") {
      reader.context().push(field, "Nullable<u32>", "type found, reading property");
